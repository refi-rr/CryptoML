...
class CryptoScanner:
    ...
    def generate_trading_advice(self, df, signal_data, sr_levels):
        ...
        if 'LONG' in trend:
            ...
            if sr_levels['support']:
                sl = sr_levels['support'][0] * 0.995  # 0.5% below support
            else:
            ...
            if sr_levels['resistance']:
                sl = sr_levels['resistance'][0] * 1.005  # 0.5% above resistance
            else:
                sl = current_price + (atr * 1.5)
        ...
        if advice['stop_loss']:
            ...
            advice['position_size_advice'] = f"Risk per trade: {risk_percent:.2f}% | Recommended: Use 1-2% of capital"
...
def main():
    ...
    print("✨ Features: S/R Detection, Entry/SL/TP Recommendations")
    print("="*80 + "\n")
    ...
    print("   • Move SL to breakeven after TP1 is hit")
    print("="*80 + "\n")
